...
<main class="container mx-auto py-8 sm:px-6 lg:px-8">
    <article class="max-w-4xl mx-auto bg-white rounded-lg shadow-md">
        ...
        <img src="<?php echo $post['image']; ?>" alt="Post Image" class="w-full rounded-t-lg">
        <div class="px-6 py-4">
            <p class="text-gray-700 text-lg mb-4">
                <?php echo $post['content']; ?>
            </p>
            <p class="text-blue-500 text-sm mb-4">
            ...
            <div class="flex flex-wrap justify-center sm:justify-start space-x-0 sm:space-x-4 space-y-4 sm:space-y-0">
                <a href="#" class="bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-full transition duration-300 ease-in-out flex-shrink-0">
                    <i class="fab fa-facebook-f mr-2"></i> Share on Facebook
                </a>
                <a href="#" class="bg-blue-400 hover:bg-blue-500 text-white py-2 px-4 rounded-full transition duration-300 ease-in-out flex-shrink-0">
                    <i class="fab fa-twitter mr-2"></i> Share on Twitter
                </a>
                <a href="#" class="bg-gray-700 hover:bg-gray-800 text-white py-2 px-4 rounded-full transition duration-300 ease-in-out flex-shrink-0">
